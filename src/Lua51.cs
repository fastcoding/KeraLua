...
namespace KeraLua
{
    ...
    public class Lua : IDisposable
    {
        ...
        {   //
            ...
            NativeMethods.luaX_setExtra(_luaState, GCHandle.ToIntPtr(handle));
        }
        ...
        private static T GetExtraObject<T>(IntPtr luaState) where T : class
        {
            ...
            IntPtr pointer = NativeMethods.luaX_getExtra(luaState);// Marshal.ReadIntPtr(extraSpace);
        ...
        {           
           NativeMethods.lua_call(_luaState, arguments, results);
        }
        ...
        /// </summary>
        /// <param name="index"></param>
        public void PushLength(int index) => NativeMethods.lua_objlen(_luaState, index);
...
#pragma warning restore IDE0018 // Inline variable declaration
        ...
        {
            return NativeMethods.lua_yield(_luaState, results);
        }
        ...
        {
            throw new Exception("Not Implemented");
             //NativeMethods.luaL_getsubtable(_luaState, index, name) != 0;
        }
        ...
        public LuaStatus LoadString(string chunk, string name)
        {
            if (name == null)
            {
                return (LuaStatus)NativeMethods.luaL_loadstring(_luaState, chunk);
            }
